...
<body>
	<%
			...
			String query = "Select meal_id, meal_name, dinein_price, meal_desc from meal ORDER BY meal_id";
		...
		<div id="menu" class="w3-container w3-black w3-xxlarge w3-padding-64">
			<h1 class="w3-center w3-jumbocustom w3-padding-32">DINE-IN MENU</h1>
		...
		do {
			...
			out.println("<form method=\"post\" action=\"W_add2cart_dinein.jsp\" onSubmit=\"return validateForm()\">");
